...
Static _TEXT dlsinp;
/*#### BK loadatinput */
Static _TEXT loadainp, list, coseq;
                             ...
                             kt_atomlage **a)
{
  ...
  *a = (kt_atomlage *)Malloc(sizeof(kt_atomlage));
  ...
  memcpy(WITH->aname, "      ", sizeof(kt_atomlagename));
  WITH->aname[0] = e[0];
  WITH->aname[1] = e[1];
...
Static Void m_initialisiere(kt_strukturdaten *strukturdaten)
{
  ...
  printf(
    " *                                                                            *\n");
  printf(
    " *   Program  KRIBER        Version 1.1    (August 1995)                      *\n");
  printf(
    " *   ===============                                                          *\n");
  printf(
    " *                                                                            *\n");
...
Static Void m_write_hilfe(void)
{
  ...
  printf("\n");
  printf(" write     input file for DLS-76 on file DLSINPUT         ==> wriid \n");
...
Static Void m_DLSinput(void)
{
  ...
  printf(" DLSinput with TETCON cards? (y/n):");
