###############################################################
#
# XTAL subprogram: GIP: Reciprocal space PIG (lattice viewer)
#
...
# It is read from the XTAL program GIP when run in the standard
# manner. 
...
proc MainWin {}  {
   wm withdraw .
   set w [toplevel .gip]
   wm title   $w "Xtal: Tk interface to GIP"
   wm minsize $w 24 20
   wm aspect  $w 480 400 480 400 ; # between 1.2 and 1.2 :-)
   xtal $w.main ; # defaults from the xtalrc file
